...
public static class CustomSettings
{
    ...
    {                
        ...
        // Timeline 相关 TrackClipTypeAttribute
        _GT(typeof(PlayableBehaviour)),
        _GT(typeof(PlayableAsset)),
        _GT(typeof(TrackAsset)),
        _GT(typeof(TimelineAsset)),
        _GT(typeof(TimelinePlayable)),
        _GT(typeof(TimelineClip)),
        _GT(typeof(TrackClipTypeAttribute)),
        _GT(typeof(ClipCaps)),
        _GT(typeof(TrackBindingTypeAttribute)),
        _GT(typeof(CommonPlayableAsset)),
        _GT(typeof(CommonPlayableBehaviour)),
        _GT(typeof(CommonTrack)),
        _GT(typeof(Playable)),
        _GT(typeof(FrameData))
