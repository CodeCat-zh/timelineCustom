...
{
    [Serializable]
    public class E_CutsceneActorAudioPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset, ITrackClipParamsConvert, ITimelineInstanceClip
    {
        ...
        {
            var playable = CommonTimelineClip.CreateCommonTimelinePlayable(graph, owner, (int)CutsceneTrackType.ActorAudioTrackType, GetParamList());
            if (playable.IsValid())
            {
                return playable;
            }
