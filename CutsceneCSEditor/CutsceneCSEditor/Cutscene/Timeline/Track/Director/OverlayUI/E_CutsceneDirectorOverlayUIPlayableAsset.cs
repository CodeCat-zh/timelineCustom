...
{
    [Serializable]
    public class E_CutsceneDirectorOverlayUIPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset, ITrackClipParamsConvert, ITimelineInstanceClip
    {
        ...
        {
            var playable = CommonTimelineClip.CreateCommonTimelinePlayable(graph, owner, (int)CutsceneTrackType.DirectorOverlayUITrackType, GetParamList());
            if (playable.IsValid())
            {
                return playable;
            }
