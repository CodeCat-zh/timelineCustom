...
{
    [Serializable]
    public class E_CutsceneDirectorSceneInOutPlayableAsset : PlayableAsset, IPropertyPreview, ITimelineClipAsset, ITrackClipParamsConvert, ITimelineInstanceClip
    {
        ...
        {
            var playable = CommonTimelineClip.CreateCommonTimelinePlayable(graph, owner, (int)CutsceneTrackType.DirectorSceneGradientTrackType, GetParamList());
            if (playable.IsValid())
            {
                return playable;
            }
